...
from jaxgm.linalg._norm import dampednorm


# @eqx.filter_jit
@jaxtyped(typechecker=beartype)
def normalize(R: Num[Array, "3 3"], eps: float = 1e-6) -> Num[Array, "3 3"]:
...
@jaxtyped(typechecker=beartype)
def perturb_left(
    key: PRNGKeyArray, R: Num[Array, "3 3"], eps: float = 1e-6
) -> Num[Array, "3 3"]:
